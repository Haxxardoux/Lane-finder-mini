...
stuff_to_try = [
    (Params(16, 1, 4e-4, 256, device), small_model(n_res_block=0, n_extra_layers=1).to(device)),
    (Params(16, 1, 4e-4, 256, device), small_model(n_res_block=0, n_extra_layers=0).to(device))
]
